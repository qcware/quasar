...
if __name__ == '__main__':
    ...
    G_fci, G_vqe, G_cis, G_fci_fd, G_vqe_fd, G_cis_fd = quasar.AIEMGradCheck.test_fd_gradient_pauli(aiem=aiem, include_vqe_response=include_vqe_response, include_cis_response=include_cis_response)
