"""
Tests for the Backend class in Backend.py
"""
...
def linear_commuting_group():
    # *** Not adding to unit test until checking with Rob about what this does
    b = quasar.Backend()
    I, X, Y, Z = quasar.Pauli.IXYZ()
    result = b.linear_commuting_group(X[0], "X")
    result = b.linear_commuting_group(Z[0]*Y[0], "Z")
    #print(result)
